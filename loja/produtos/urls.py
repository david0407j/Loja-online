...
urlpatterns = [
    ...
    path(
        "meucarrinho/adicionar/<int:produto_id>",
    ...
    path(
        "meucarrinho/compra/finalizar",
        views.finalizar_compra_whatsapp,
        name="carrinho.finalizar.compra",
    ),
    path(
        "adicionar/<int:produto_id>/",
        views.adicionar_no_carrinho,
        name="adicionar_no_carrinho",
    ),
]
